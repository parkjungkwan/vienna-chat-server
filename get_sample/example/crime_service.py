...
class CrimeService:
    ...
    def save_crime_arrest_normalization(self) -> None:
        ...
        police['살인검거율'] = police['살인검거'].astype(int) / police['살인'].astype(int) * 100
        police['강도검거율'] = police['강도검거'].astype(int) / police['강도'].astype(int) * 100
        police['강간검거율'] = police['강간검거'].astype(int) / police['강간'].astype(int) * 100
        police['절도검거율'] = police['절도검거'].astype(int) / police['절도'].astype(int) * 100
        police['폭력검거율'] = police['폭력검거'].astype(int) / police['폭력'].astype(int) * 100
